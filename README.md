...
- The DESIGN modal now analyzes uploaded PNG/JPG/SVG artwork in-browser using a canvas buffer scaled down to a maximum dimension of 2000px for performance.
